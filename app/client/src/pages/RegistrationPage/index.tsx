...
import { CustomCheckbox, CustomFormControlLabel, CustomInputField, useStyles } from "./styles";
...
function RegistrationPage() {
  ...
  const handleAgreementChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    setRegistrationDetails({ ...registrationDetails, [event.target.name]: event.target.checked });
  };
  ...
  const submitForm = e => {
    ...
    fetch(postUrl, {
      ...
      .then((response) => {
        ...
        window.location.href='https://chaoscarnival.io/acknowledgement'
      })
      .catch(err => {
        setError(err);
        setLoading(false);
	...
	return (
			...
			<div className={classes.rootContainer}>
                ...
                <div className={classes.formArea}>
                  <div className={classes.formDescription}>
                    <Typography className={classes.registerForText}>Register for</Typography>
        ...
        <FormControl
          ...
          onSubmit={submitForm}
        >
                <CustomInputField id="contact-first-name" type="text" required name="firstname" value={registrationDetails.firstname} onChange={handleDetailsChange} placeholder="First Name*" className={classes.inputField}/>
                <CustomInputField id="contact-last-name" type="text" required name="lastname" value={registrationDetails.lastname} onChange={handleDetailsChange} placeholder="Last Name*" className={classes.inputField}/>
                <CustomInputField id="contact-email" type="email" required name="email" value={registrationDetails.email} onChange={handleDetailsChange} placeholder="Email*" className={classes.inputField}/>
                <CustomInputField id="contact-company" type="text" required name="company" value={registrationDetails.company} onChange={handleDetailsChange} placeholder="Company*" className={classes.inputField}/>
                <CustomInputField id="contact-job-title" type="text" required name="jobtitle" value={registrationDetails.jobtitle} onChange={handleDetailsChange} placeholder="Job Title*" className={classes.inputField} />
                <CustomFormControlLabel
                  className={classes.checkboxLabel}
                    control={
                      <CustomCheckbox
                        checked={registrationDetails.agree}
                ...
                <Button
                      className={
                        ...
                        registrationDetails.firstname !== '' &&
                          ...
                          registrationDetails.jobtitle !== ' '
                        ?
                        `${classes.registerButtonActive}` : `${classes.registerButton}`}
                  color="primary"
                  variant="contained"
                  type="submit"
                  onClick={(event: any) => {
                  ...
                  {error ? (<Typography
                    ...
                    style={{ textTransform: "none" }}
                  >
                    <b>There was a problem during registration ! <br/>Please try again</b>
                  </Typography>) : (<div/>)}
                  </div>
                  </FormControl>
                  </div>
