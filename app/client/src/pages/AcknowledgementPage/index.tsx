                  ...
                  >
                    Registering
								...
								<Typography
									...
									style={{ margin: "auto", textAlign: 'center' }}
								>
									You’ll soon receive a confimation email with event details. Meanwhile you can save the dates to calendar and feel free to join our slack community.
							</Typography>
              </div>
              <div style={{ margin: "auto" }}>
                <div className={classes.buttons}>
                  <Button
						...
						color="primary"
                    variant="outlined"
                    style={{ margin: "auto", padding: "1.5rem", marginTop: "2rem", width: "46.5%" }}
						onClick={() => {
							window.open(
                  ...
                  >
                    <Typography
									...
									>
                      <img src='./icons/Slack.svg' alt='Slack Icon' className={classes.slack}/>
                      &emsp;
									</Typography>
									<Typography
										className={classes.registerText}
            ...
            <div style={{ margin: "auto" }}>
                ...
                >
                  <a
								...
								>
                    <img src='./icons/social/Fb.svg' alt='Facebook' className={classes.footerIconImages} />
                    </a>
                  &emsp;&emsp;
                  <a
									...
									style={{ textDecoration: "none" }}
								>
                    <img src='./icons/social/Twitter.svg' alt='Twitter' className={classes.footerIconImages} />
                    </a>
                  &emsp;&emsp;
                  <a
									...
									style={{ textDecoration: "none" }}
								>
                    <img src='./icons/social/Linkedin.svg' alt='Linkedin' className={classes.footerIconImages} />
                    </a>
                  &emsp;&emsp;
                  <a
									...
									style={{ textDecoration: "none" }}
								>
                    <img src='./icons/social/Medium.svg' alt='Medium' className={classes.footerIconImages} />
                    </a>
                  &emsp;&emsp;
                  <a
									...
									style={{ textDecoration: "none" }}
								>
                    <img src='./icons/social/Youtube.svg' alt='Youtube' className={classes.footerIconImages} />
                    </a>
							</Typography>	
              </div>
              </div>
