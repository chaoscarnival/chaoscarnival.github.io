export default [
	...
	},
	{
		...
		speaker2: {
			sessionName: `[Session 2] Stand up for Chaos!`,
			speaker: [
				{
	...
	},
	{
		...
		speaker2: {
			sessionName: `[Session 4] In the kitchen: A sprinkle of fire and chaos`,
			speaker: [
				{
	...
	},
	{
		...
		speaker2: {
			sessionName: `[Session 6] It wont make a noise when it breaks`,
			speaker: [
				{
					name: "Piyush Verma",
					role: "Co-Founder & CTO",
	...
	},
	{
		...
		speaker2: {
			sessionName: `[Session 8] Putting Chaos into Continuous Delivery - how to increase the resilience of your applications`,
			speaker: [
				{
	...
	},
	{
		...
		speaker1: {
			...
			tags: ["incidents", "postmortems", "chaos engineering"],
			id: 24,
		},
		speaker2: {
			sessionName: `[Session 10] Chaos Engineering is fun!`,
			speaker: [
				{
					name: "Eugenio Marzo",
			...
			tags: ["kubernetes", "chaos", "spaceinvaders"],
			id: 25,
		},
	},
	{
		...
		speaker1: {
			...
			tags: ["chaos-engineering", "chaos-engineering-tools"],
			id: 26,
		},
		speaker2: {
			sessionName: `[Session 12] Evolution in Chaos Engineering`,
			speaker: [
				{
					name: "Sumit Nagal",
	...
	},
	{
		...
		speaker2: {
			sessionName: `[Session 13] Chaos with Care`,
			speaker: [
				{
					name: "Carl Chesser",
					role: "Principal Engineer",
			...
			tags: ["healthcare", "chaos-engineering"],
			id: 29,
		},
	},
];
